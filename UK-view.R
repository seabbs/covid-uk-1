...
ggsave("~/Dropbox/COVID-UK/fig-triggers.pdf", f, width = 20, height = 9, units = "cm", useDingbats = F);
...
pla1 = plot_epi(d3[compartment != "deaths" & compartment != "beds_nonicu" & compartment != "cases" & 
        ...
        colours = cols5[2:3], maxy = 26000) + geom_hline(data = data.table(scenario = "Lockdown 1000-bed trigger", beds = c(4800, 9600), lt = c("a", "b")),
